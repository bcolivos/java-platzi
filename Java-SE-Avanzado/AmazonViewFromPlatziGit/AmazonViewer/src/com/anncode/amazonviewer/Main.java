 ...
 * o leidos a expecion de las Magazines, estas solo pueden ser vistas a modo de 
...
public class Main {
	...
	public static void makeReport() {
		...
		//<Serie> seriesViewed = s -> s.getIsViewed();
		//series.stream().filter(seriesViewed).forEach(arg0);
